...
class AuthController extends Controller
{
    ...
    {
        return ApiResponse::ok(new UserResource($this->service->me($request->user())));
    }
    ...
    public function forgotPassword(ForgotPasswordRequest $request)
    {
        ...
        return ApiResponse::ok(['status' => $status], 'Si el correo existe, se envió el enlace de recuperación.');
    }
    ...
    public function changePassword(ChangePasswordRequest $request)
    {
        ...
        return ApiResponse::ok(null, 'Contraseña actualizada');
    }
}
